...
export const en = {
  ...
  prayerText: {
    showFullText: "Show the full prayer text",
  },
  rosary: {
    guideLabel: "Today's Rosary",
    position: "{current} / {total}",
    decade: "Decade {n}",
    creed: "Opening · Apostles' Creed",
    ourFather: "Our Father",
    hailMary: "Hail Mary",
    gloryBe: "Glory Be",
    salvation: "Fatima Prayer",
    closing: "Closing · Hail Holy Queen",
    previous: "Back",
    next: "Next",
    finish: "Done",
  ...
  platformChoice: {
    ...
    androidManualTitle: "Add to your Home Screen?",
    androidManualBody:
  ...
  lab: {
    ...
    beadStatus: "Hail Mary {n} / {total}",
    totalStatus: "{n} / {total} beads",
    roundDone: "All 5 decades complete",
    tapForNewRound: "Tap to start again",
    roundsCount: "{n} full rosaries completed",
    undoBead: "Undo one bead",
    resetRound: "Start over",
    resetConfirmTitle: "Start over from the beginning?",
    resetConfirmBody: "This clears the {n} beads counted so far and restarts from decade 1.",
    viewMeditation: "View the image and meditation",
    notSaved: "Counts here are not saved and never affect your weekly report.",
  },
  common: {
    save: "Save",
    cancel: "Cancel",
