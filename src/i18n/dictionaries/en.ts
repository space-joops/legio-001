...
export const en = {
  ...
  secretaryAnnual: {
    title: "Annual Report",
    subtitle: "Builds the annual report from a year of monthly reports.",
    listTitle: "Annual reports",
    empty: "No annual reports yet.",
    newTitle: "New annual report",
    yearLabel: "Year",
    create: "Create",
    alreadyExists: "A report for this year already exists. Open it from the list.",
    open: "Open",
    deleteConfirmTitle: "Delete this annual report?",
    deleteConfirmBody: "This cannot be undone.",
    notFound: "This annual report could not be found.",
    backToList: "Back to annual reports",
    titlePrefix: "Praesidium Annual Report No.",
    titleSuffix: "",
    reportNumberLabel: "Report number",
    submittedOn: "Submitted on",
    parishNameLabel: "Parish",
    foundedOn: "Founded on",
    approvedOn: "Approved on",
    deputyDirector: "Deputy spiritual director",
    periodLabel: "Reporting period",
    yearSuffix: "",
    weekSuffix: " weeks",
    basicSection: "Basic information",
    officersSection: "Officers",
    praesidiumAttendance: "Pr. attendance",
    councilAttendance: "Council attendance",
    officerTransfer: "Officer changes",
    memberAttendance: "Member attendance",
    memberCountsSection: "Member counts",
    previousReport: "At last report",
    current: "Current",
    change: "Change",
    ...
    lineLabelPlaceholder: "Line name",
    eventsSection: "Events",
    formationsSection: "Formation & retreats",
    othersSection: "Other events",
    addEvent: "Add event",
    eventKindLabel: "Kind",
    loadFromMonthly: "Load from monthly reports",
    loadedFromMonthly: "Loaded key activities from the monthly reports.",
    activitySection: "Activities",
    activityCategory: "Category",
    activityCount: "Count",
    activityDetail: "Detail",
    dioceseCategory: "Diocese / Senatus instructions",
    parishCategory: "Parish instructions",
    operationSection: "Praesidium operations",
    operationNotes: "Difficulties overcome and things to celebrate",
    issueTitle: "Operational issue - title",
    issueBody: "Operational issue - detail",
    issueAction: "Operational issue - action",
    refresh: "Recalculate from monthly reports",
    refreshed: "Recalculated from the monthly reports.",
    refreshHint:
      "Prayers, attendance, member counts, treasury and session numbers come from that year's monthly reports. Press this after editing them; council attendance and officer notes you typed are kept.",
    monthCountLabel: "Monthly reports used",
    monthCountUnit: "",
    formNumber: "Seoul Immaculate Conception Senatus Form No. 7 (Dec 2024)",
  },
  secretaryReport: {
    ...
    activityTalliesHint:
      "Entering counts by category fills the activity line below automatically and lets the annual report total the year for you. Categories that don't apply can stay collapsed.",
