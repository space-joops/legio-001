export const ko = {
  ...
  lab: {
    ...
    tapToStart: "눌러서 시작하세요",
    beadStatus: "성모송 {n} / {total}",
    totalStatus: "전체 {n} / {total}알",
    roundDone: "5단을 모두 바쳤습니다",
    tapForNewRound: "눌러서 새로 시작",
    roundsCount: "완주 {n}바퀴",
    undoBead: "한 알 되돌리기",
    resetRound: "처음부터",
    resetConfirmTitle: "처음부터 다시 셀까요?",
    resetConfirmBody: "지금까지 센 {n}알을 지우고 1단부터 다시 시작합니다.",
    viewMeditation: "성화와 묵상 보기",
    notSaved: "여기서 센 숫자는 저장되지 않고, 주간 보고에도 반영되지 않습니다.",
  },
  common: {
    save: "저장",
    cancel: "취소",
