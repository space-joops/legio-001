...
const FATIMA_PRAYER_KO = [
  "오 나의 예수님, 저희 죄를 용서하시고",
  "저희를 지옥불에서 구하여 주시며",
  "모든 영혼을, 특히 주님의 자비가 가장 필요한 영혼을",
  "천국으로 이끌어 주소서. 아멘.",
];
...
const APOSTLES_CREED_KO = [
  ...
  "본시오 빌라도 통치 아래서 고난을 받으시어",
  "십자가에 못박혀 돌아가시고 묻히시며",
  "저승에 가시어 사흗날에 죽은 이들 가운데서 다시 살아나시고",
...
const SALVE_REGINA_KO = [
  "자비로우신 어머니, 우리 생명 우리 즐거움 우리 희망이신 여왕이여, 만세!",
  "하와의 자손인 우리는 귀양살이하는 자녀로서",
  "슬피 울며 이 눈물의 골짜기에서 당신께 부르짖나이다.",
  "그러하오니 저희를 위하여 빌어주시는 이여,",
  "자비로운 그 눈으로 우리를 돌아보시고",
  "이 귀양살이 다한 뒤에 당신 태중에 나신",
  "복되신 아들 예수를 우리에게 보여주소서.",
  "오, 인자하시고 자비로우시며 오, 감미로우신 동정 마리아여. 아멘.",
];
  ...
  rosaryDecades: {
    ko: {
      sections: [
        ...
        { heading: "주님의 기도", lines: OUR_FATHER_KO },
        { heading: "성모송 (3번 · 신덕·망덕·애덕을 위하여)", lines: HAIL_MARY_KO },
        { heading: "영광송", lines: GLORY_BE_KO },
        {
          heading: "한 단의 순서",
          lines: [
        ...
        { heading: "파티마의 기도", lines: FATIMA_PRAYER_KO },
        {
      ...
      note: "'마침 기도(성모찬송)'는 공식 번역 인용이 아닌 널리 쓰이는 일반적인 문구입니다. 나머지 기도문은 공식 전례 문구입니다.",
    },
    en: {
      sections: [
