import type { PrayerTextEntry } from "./prayerTexts";
...
export interface TesseraChapter {
  /** 목차 앵커 id. 페이지 안 링크(`#opening`)가 이 값을 쓴다. */
  id: TesseraChapterId;
  /** 목차와 본문 소제목에 함께 쓰는 장 이름. */
  title: string;
  entry: PrayerTextEntry;
}

const SIGN_OF_CROSS = "† 성부와 성자와 성령의 이름으로. 아멘.";
