...
## 8. AI 코딩 도구 (Claude Code) 활용
이 프로젝트는 Claude Code 같은 AI 코딩 도구와 함께 개발하는 것을 염두에 두고 있습니다(프로젝트 규칙은 `CLAUDE.md`/`AGENTS.md`에 정리되어 있습니다). 이 프로젝트에 알맞은 플러그인·스킬 목록과 설치 방법, 사용법은 [CLAUDE_CODE_GUIDE.md](CLAUDE_CODE_GUIDE.md)를 참고해 주세요.
